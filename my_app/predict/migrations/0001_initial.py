    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('case_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='predict.case')),
            ],
        ),
        migrations.AddField(
            model_name='case',
            name='client_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='predict.client'),
        ),
        migrations.CreateModel(
            name='Documents',
            fields=[
        ...
        migrations.AddField(
            model_name='case',
            name='lawyer_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='predict.lawyer'),
        ),
        migrations.CreateModel(
            name='LegalResearch',
            fields=[
                ...
                ('legal_caseid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='predict.case')),
            ],
        ),
    ]
