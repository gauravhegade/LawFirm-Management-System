    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lawyer_app.client')),
                ('lawyer_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lawyer_app.lawyer')),
            ],
        ),
        migrations.CreateModel(
            name='Documents',
            fields=[
                ...
                ('case_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lawyer_app.case')),
            ],
        ),
        migrations.CreateModel(
            name='LegalResearch',
            fields=[
                ...
                ('legal_caseid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lawyer_app.case')),
            ],
        ),
    ]
